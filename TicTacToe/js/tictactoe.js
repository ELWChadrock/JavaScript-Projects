//This variablle keeps track of who's turn it is.
let activePlayer = "X";
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        checkWinConditions();
        //This condidtion is for changing the active player.
        if (activePlayer === 'X') {
        ...
        function computersTurn() {
            ...
            let pickASquare;
            //This condidtion allows our while loop to keep
...
function checkWinConditions() {
    ...
    function disableClick() {
        ...
        setTimeout(function() {body.style.pointer = 'auto';}, 1000);
    }
    ...
    //This function utilizies html canvas to draw win lines.
    function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
        ...
        x2 = coordX2,
        //This line indicates where the end of x axis is.
        y2 = coordY2,
    ...
    function animateLineDrawing() {
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            if (y < y2) { y += 10; }
            //This condition cacnels our animation loop if we reach the end points
        ...
        disableClick();
        //This line pllays the win sounds.
