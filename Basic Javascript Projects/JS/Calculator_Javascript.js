...
const Calculator = {
    ...
    First_Operand: null,
    //this checks wheather or not the second operand has been inputted
    Wait_Secont_Operand: false,
...
function Input_Decimal(dot) {
    ...
    if(Calculater.Wait_Second_Operand == true) return;
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator already exists and if Wait_Second_Operand s true,
    ...
    //this will remoe any trailing 0's
...
function Calculator_Reset() {
    ...
    Calculator.Wait_Secont_Operand = false;
